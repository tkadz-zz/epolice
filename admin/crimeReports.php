    ...
    <div class="col-12">
        ...
        <div id="printableArea" class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold -text-primary">Unsolved Crime Reports</h6><br>
                <a class="btn btn-sm btn-outline-primary" href="solvedCrimeReports.php">View Solved Crime Reports</a>
            </div>
            <div class="card-body">
