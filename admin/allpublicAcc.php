        ...
        <form method="GET">
            ...
            <div class="inner-form row">
                <div class="input-field second-wrap col-md-8">
                    <input class="form-control" <?php if(isset($_GET['search'])){?> value="<?php echo $_GET['search'] ?>" <?php } ?> id="search" pattern="[ a-zA-Z0-9]+" name="search" type="search" placeholder="Search by Name, Surname, nationalID, studentID..." />
                </div>
        ...
        <div class="col-12">
            ...
            <div id="printableArea" class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">All Student Accounts</h6>
                </div>
                    <div class="card-body">
                    <div class="table-responsive">
                        <table class="table -datatable table-hover" >
                            ...
                            if (isset($_GET['search'])) {
                                $search = $_GET['search'];
                                $query = "SELECT * FROM public WHERE name LIKE '%$search%' OR secondName LIKE '%$search%' OR surname LIKE '%$search%' OR nationalID LIKE '%$search%' ORDER BY id DESC";
                            } else {
                                $query = "SELECT * FROM public  ORDER BY id DESC";
                            }
