...
if(isset($_SESSION['type']) && isset($_SESSION['err'])) {
    ...
    if($type == 'd'){
        ...
        <div -id="divDis" class="animated--grow-in fadeout -my-3 -p-3 bg-danger-light rounded shadow-sm alert alert-danger">
            <div class="closebtn">
    ...
    elseif($type == 'i'){
        ?>
        <div -id="divDis" class="animated--grow-in --text-dark fadeout -my-3 -p-3 bg-info-light rounded shadow-sm alert alert-secondary">
            <div class="closebtn">
                <!-- <span style="color: firebrick" class="fa fa-window-close"></span> -->
            </div>
    ...
    elseif ($type == 'w'){
        //  WARNING MODAL
        ?>
        <div -id="divDis" class="animated--grow-in fadeout -my-3 -p-3 bg-warning-light rounded shadow-sm alert alert-warning">
            <div class="closebtn">
                <!-- <span style="color: firebrick" class="fa fa-window-close"></span> -->
            </div>
    ...
    elseif ($type == 's'){
        //  SUCCESS MODAL
        ?>
        <div id="divDis" class="animated--grow-in fadeout -my-3 -p-3 --text-white bg-success-light rounded shadow-sm alert alert-success">
            <div class="closebtn">
                <!-- <span style="color: firebrick" class="fa fa-window-close"></span> -->
            </div>
